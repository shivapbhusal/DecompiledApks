...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new C01881();
    ...
    class C01914 implements OnAttachListener {
        C01914() {
        }
    ...
    class C01935 implements Runnable {

        class C01921 extends ViewPropertyAnimatorListenerAdapter {
            C01921() {
            }
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C01921());
        }
    }

    class C01946 extends ViewPropertyAnimatorListenerAdapter {
        C01946() {
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C01951());
            }
    ...
    final class PanelFeatureState {
        ...
        class SavedState implements Parcelable {
            public static final Creator CREATOR = ParcelableCompat.newCreator(new C01961());
            int featureId;
            boolean isOpen;
            Bundle menuState;

            final class C01961 implements ParcelableCompatCreatorCallbacks {
                C01961() {
                }
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(view2, new C01892());
                    view = view2;
                } else {
                    ((FitWindowsViewGroup) view2).setOnFitSystemWindowsListener(new C01903());
                    view = view2;
                }
            ...
            contentFrameLayout.setAttachListener(new C01914());
            return view;
        }
        obtainStyledAttributes.recycle();
    ...
    private void doInvalidatePanelMenu(int i) {
        ...
        if ((i == AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR || i == 0) && this.mDecorContentParent != null) {
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR) && this.mDecorContentParent != null) {
            TypedValue typedValue = new TypedValue();
    ...
    private boolean preparePanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        boolean z = panelFeatureState.featureId == 0 || panelFeatureState.featureId == AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR;
    ...
    boolean onMenuOpened(int i, Menu menu) {
        if (i != AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR) {
            return false;
        }
        ActionBar supportActionBar = getSupportActionBar();
        if (supportActionBar == null) {
    ...
    public boolean requestWindowFeature(int i) {
        int sanitizeWindowFeatureId = sanitizeWindowFeatureId(i);
        if (this.mWindowNoTitle && sanitizeWindowFeatureId == AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR) {
            return false;
        }
        ...
        if (actionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new C01935();
                } else {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(standaloneActionMode, standaloneActionMode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new C01946());
                    if (this.mActionModePopup != null) {
