...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02011();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02022();
    private boolean mShowingForMode;
    private ScrollingTabContainerView mTabScrollView;
    private ArrayList mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02033();
    ...
    class C02022 extends ViewPropertyAnimatorListenerAdapter {
        C02022() {
        }
    ...
    class C02033 implements ViewPropertyAnimatorUpdateListener {
        C02033() {
        }
