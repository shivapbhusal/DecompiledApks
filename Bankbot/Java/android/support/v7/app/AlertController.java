    ...
    public class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                simpleCursorAdapter = new ArrayAdapter(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) {
                ...
                Object c01842 = new CursorAdapter(this.mContext, this.mCursor, false) {
