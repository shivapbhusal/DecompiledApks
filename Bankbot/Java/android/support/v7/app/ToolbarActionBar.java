...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C01992();
    private final Runnable mMenuInvalidator = new C01981();
    ...
    class C01992 implements OnMenuItemClickListener {
        C01992() {
        }
