...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02161 extends DataSetObserver {
        C02161() {
        }
    ...
    class C02194 extends DataSetObserver {
        C02194() {
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetOberver = new C02161();
        this.mOnGlobalLayoutListener = new C02172();
        ...
        this.mAdapter.registerDataSetObserver(new C02194());
