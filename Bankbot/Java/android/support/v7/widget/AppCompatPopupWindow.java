...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    final class C02211 implements OnScrollChangedListener {
        ...
        C02211(Field field, PopupWindow popupWindow, OnScrollChangedListener onScrollChangedListener) {
    ...
    private static void wrapOnScrollChangedListener(PopupWindow popupWindow) {
        try {
            ...
            declaredField2.set(popupWindow, new C02211(declaredField, popupWindow, (OnScrollChangedListener) declaredField2.get(popupWindow)));
        } catch (Throwable e) {
