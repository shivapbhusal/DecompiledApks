...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02344 implements OnFocusChangeListener {
        C02344() {
        }
    ...
    class C02355 implements OnLayoutChangeListener {
        C02355() {
        }
    ...
    class C02366 implements OnGlobalLayoutListener {
        C02366() {
        }
    ...
    class C02377 implements OnClickListener {
        C02377() {
        }
    ...
    class C02388 implements OnKeyListener {
        C02388() {
        }
    ...
    class C02399 implements OnEditorActionListener {
        C02399() {
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.mShowImeRunnable = new C02311();
        this.mUpdateDrawableStateRunnable = new C02322();
        this.mReleaseCursorRunnable = new C02333();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02377();
        this.mTextKeyListener = new C02388();
        this.mOnEditorActionListener = new C02399();
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02344());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C02366());
    }

    @TargetApi(11)
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C02355());
    }
