...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class DropdownPopup extends ListPopupWindow {
        ...
        class C02242 implements OnGlobalLayoutListener {
            C02242() {
            }
        ...
        public void show() {
            ...
            if (!isShowing) {
                ...
                if (viewTreeObserver != null) {
                    final OnGlobalLayoutListener c02242 = new C02242();
                    viewTreeObserver.addOnGlobalLayoutListener(c02242);
                    setOnDismissListener(new OnDismissListener() {
                        public void onDismiss() {
                            ViewTreeObserver viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver();
                            if (viewTreeObserver != null) {
                                viewTreeObserver.removeGlobalOnLayoutListener(c02242);
                            }
                        }
                    });
                }
