...
public class ListPopupWindow {
    ...
    public abstract class ForwardingListener implements OnTouchListener {
        ...
        private boolean onTouchForwarded(MotionEvent motionEvent) {
            ...
            boolean z2 = (actionMasked == 1 || actionMasked == 3) ? ListPopupWindow.DEBUG : true;
    ...
    class C02283 implements OnItemSelectedListener {
        C02283() {
        }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C02272();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C02283());
