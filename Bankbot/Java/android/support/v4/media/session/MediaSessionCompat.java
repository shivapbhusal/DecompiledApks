...
public class MediaSessionCompat {
    ...
    class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C00991();
        private VolumeProviderCompat mVolumeProvider;
        private int mVolumeType;

        class C00991 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C00991() {
            }
        ...
        class C01002 implements Callback {
            C01002() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            Object c01002 = new C01002();
            if (VERSION.SDK_INT >= 18) {
                MediaSessionCompatApi18.setOnPlaybackPositionUpdateListener(this.mRccObj, MediaSessionCompatApi18.createPlaybackPositionUpdateListener(c01002));
            }
            if (VERSION.SDK_INT >= 19) {
                MediaSessionCompatApi19.setOnMetadataUpdateListener(this.mRccObj, MediaSessionCompatApi19.createMetadataUpdateListener(c01002));
            }
        }
    ...
    public final class QueueItem implements Parcelable {
        public static final Creator CREATOR = new C01011();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        final class C01011 implements Creator {
            C01011() {
            }
    ...
    final class ResultReceiverWrapper implements Parcelable {
        public static final Creator CREATOR = new C01021();
        private ResultReceiver mResultReceiver;

        final class C01021 implements Creator {
            C01021() {
            }
    ...
    public final class Token implements Parcelable {
        public static final Creator CREATOR = new C01031();
        private final Object mInner;

        final class C01031 implements Creator {
            C01031() {
            }
