...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00924();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00935();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00913();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00946();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00891();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00902();

    class C00891 implements OnWindowAttachListener {
        C00891() {
        }
    ...
    class C00902 implements OnWindowFocusChangeListener {
        C00902() {
        }
    ...
    class C00913 extends BroadcastReceiver {
        C00913() {
        }
    ...
    class C00924 implements OnAudioFocusChangeListener {
        C00924() {
        }
    ...
    class C00935 implements OnGetPlaybackPositionListener {
        C00935() {
        }
    ...
    class C00946 implements OnPlaybackPositionUpdateListener {
        C00946() {
        }
