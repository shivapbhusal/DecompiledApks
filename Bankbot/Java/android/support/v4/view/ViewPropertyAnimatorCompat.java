...
public final class ViewPropertyAnimatorCompat {
    ...
    class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
        ...
        public void mo751x(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f) {
            postStartMessage(viewPropertyAnimatorCompat, view);
        }
        ...
        public void mo753y(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f) {
            postStartMessage(viewPropertyAnimatorCompat, view);
        }
        ...
        public void mo755z(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f) {
        }
    ...
    class ICSViewPropertyAnimatorCompatImpl extends BaseViewPropertyAnimatorCompatImpl {
        ...
        public void mo751x(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f) {
            ViewPropertyAnimatorCompatICS.m88x(view, f);
        }
        ...
        public void mo753y(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f) {
            ViewPropertyAnimatorCompatICS.m89y(view, f);
        }
    ...
    class LollipopViewPropertyAnimatorCompatImpl extends KitKatViewPropertyAnimatorCompatImpl {
        ...
        public void mo755z(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f) {
            ViewPropertyAnimatorCompatLollipop.m90z(view, f);
        }
    ...
    public ViewPropertyAnimatorCompat m85x(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo751x(this, view, f);
        }
        return this;
    }
    ...
    public ViewPropertyAnimatorCompat m86y(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo753y(this, view, f);
        }
        return this;
    }
    ...
    public ViewPropertyAnimatorCompat m87z(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo755z(this, view, f);
        }
        return this;
    }
