...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator COMPARATOR = new C01331();
    ...
    private static final Interpolator sInterpolator = new C01342();
    ...
    private final Runnable mEndScrollRunnable = new C01353();
    ...
    final class C01331 implements Comparator {
        C01331() {
        }
    ...
    final class C01342 implements Interpolator {
        C01342() {
        }
    ...
    class C01364 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public class SavedState extends BaseSavedState {
        public static final Creator CREATOR = ParcelableCompat.newCreator(new C01371());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        final class C01371 implements ParcelableCompatCreatorCallbacks {
            C01371() {
            }
    ...
    void dataSetChanged() {
        ...
        boolean z = (this.mItems.size() >= (this.mOffscreenPageLimit * 2) + 1 || this.mItems.size() >= count) ? DEBUG : true;
        boolean z2 = DEBUG;
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        switch (keyEvent.getKeyCode()) {
            ...
            case 61:
                return VERSION.SDK_INT >= 11 ? KeyEventCompat.hasNoModifiers(keyEvent) ? arrowScroll(2) : KeyEventCompat.hasModifiers(keyEvent, 1) ? arrowScroll(1) : DEBUG : DEBUG;
            default:
                return DEBUG;
        }
    }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01364());
    }
