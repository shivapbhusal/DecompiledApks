...
class ViewPropertyAnimatorCompatICS {
    ...
    final class C01391 extends AnimatorListenerAdapter {
        ...
        C01391(ViewPropertyAnimatorListener viewPropertyAnimatorListener, View view) {
    ...
    public static void setListener(View view, ViewPropertyAnimatorListener viewPropertyAnimatorListener) {
        if (viewPropertyAnimatorListener != null) {
            view.animate().setListener(new C01391(viewPropertyAnimatorListener, view));
        } else {
    ...
    public static void m88x(View view, float f) {
        view.animate().x(f);
    }
    ...
    public static void m89y(View view, float f) {
        view.animate().y(f);
    }
