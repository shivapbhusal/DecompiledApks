...
class FragmentTransitionCompat21 {
    ...
    final class C00431 extends EpicenterCallback {
    ...
    final class C00442 implements OnPreDrawListener {
        ...
        C00442(View view, Transition transition, View view2, ViewRetriever viewRetriever, Map map, Map map2, ArrayList arrayList) {
    ...
    final class C00453 extends EpicenterCallback {
        private Rect mEpicenter;
        final /* synthetic */ EpicenterView val$epicenterView;

        C00453(EpicenterView epicenterView) {
    ...
    final class C00464 implements OnPreDrawListener {
        final /* synthetic */ Transition val$enterTransition;
        final /* synthetic */ ArrayList val$enteringViews;
        ...
        C00464(View view, Transition transition, ArrayList arrayList, Transition transition2, ArrayList arrayList2, Transition transition3, ArrayList arrayList3, Map map, ArrayList arrayList4, Transition transition4, View view2) {
    ...
    public static void addTransitionTargets(Object obj, Object obj2, View view, ViewRetriever viewRetriever, View view2, EpicenterView epicenterView, Map map, ArrayList arrayList, Map map2, Map map3, ArrayList arrayList2) {
        if (obj != null || obj2 != null) {
            ...
            if (viewRetriever != null) {
                view.getViewTreeObserver().addOnPreDrawListener(new C00442(view, transition, view2, viewRetriever, map, map3, arrayList));
            }
    ...
    public static void cleanupTransitions(View view, View view2, Object obj, ArrayList arrayList, Object obj2, ArrayList arrayList2, Object obj3, ArrayList arrayList3, Object obj4, ArrayList arrayList4, Map map) {
        ...
        if (transition4 != null) {
            view.getViewTreeObserver().addOnPreDrawListener(new C00464(view, transition, arrayList, transition2, arrayList2, transition3, arrayList3, map, arrayList4, transition4, view2));
        }
    }
    ...
    public static void setEpicenter(Object obj, View view) {
        ((Transition) obj).setEpicenterCallback(new C00431(getBoundsOnScreen(view)));
    }

    private static void setSharedElementEpicenter(Transition transition, EpicenterView epicenterView) {
        if (transition != null) {
            transition.setEpicenterCallback(new C00453(epicenterView));
        }
    }
