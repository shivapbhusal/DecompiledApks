...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    class C00291 extends FragmentContainer {
        C00291() {
        }
    ...
    public class SavedState implements Parcelable {
        public static final Creator CREATOR = new C00301();
        final Bundle mState;

        final class C00301 implements Creator {
            C00301() {
            }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C00291(), this);
    }
