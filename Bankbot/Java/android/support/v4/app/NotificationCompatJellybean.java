...
class NotificationCompatJellybean {
    ...
    public class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        private android.app.Notification.Builder f92b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f92b, action));
        }

        public Notification build() {
            Notification build = this.f92b.build();
