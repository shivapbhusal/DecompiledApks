...
class NotificationCompatKitKat {
    ...
    public class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        private android.app.Notification.Builder f93b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f93b, action));
        }
        ...
        public Notification build() {
            ...
            this.f93b.setExtras(this.mExtras);
            return this.f93b.build();
        }
