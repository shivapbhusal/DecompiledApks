...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Callback mCallback = new C01593();
    boolean mFinishing;
    ...
    class C01593 implements Callback {
        C01593() {
        }
    ...
    private void setupAnimators() {
        ...
        Animation c01571 = new Animation() {
        ...
        c01571.setRepeatCount(-1);
        c01571.setRepeatMode(1);
        c01571.setInterpolator(LINEAR_INTERPOLATOR);
        c01571.setAnimationListener(new AnimationListener() {
