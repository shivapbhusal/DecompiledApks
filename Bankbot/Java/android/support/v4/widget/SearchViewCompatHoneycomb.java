...
class SearchViewCompatHoneycomb {
    ...
    final class C01631 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01631(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    final class C01642 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01642(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
